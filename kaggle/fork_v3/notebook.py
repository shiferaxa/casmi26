# v3 of the fork: ranker-features pinned to v4, canonical-key dedupe, nearest-mass fill to 25,
...
class CFG:
    ...
    PRUNE_N      = 400    # v3: candidates kept after the coarse prune (public pipeline used 80)
